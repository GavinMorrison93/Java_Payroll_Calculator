//In this part of the program we extend the Employee class into the subclass of Manager and
...
public class Manager extends Employee implements Comparable<Employee>{
    ...
    public Manager(String Name, int EmployeeID, String r, double w, double nw, String d){
...
// This is where we calculate the Netwage of our Managers.         
    
    public void setNetWage(double nw){
        Netwage =nw;
        Netwage = Wage - (Wage /100) *40;
    }
